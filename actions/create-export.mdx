...
<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/6d24ba8d-8656-4a8b-9a87-b886fa0e46e8.jpg" alt="Export Option" />
</Frame>

After which, the following screen would appear. Click on **Create export** to get started.

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/b3615ac3-65ca-4181-af18-f2478f917ad0.jpg" alt="Create Export" />
</Frame>

Here in the redirected page, click on the Status filters to make changes to the filter settings.

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/a8948fb6-ee0e-4888-a540-fa7bc0c6af33.jpg" alt="Status Filters" />
</Frame>
...
<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/ea9cc369-424c-435e-a2f7-8209287dab61.jpg" alt="Select Status Filter" />
</Frame>

Scroll down to click the button **Apply Filters**.

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/44755272-99d1-4c18-9304-54e7aaecd88c.jpg" alt="Apply Filters Button" />
</Frame>

In the resulting screen, you can select the **'Export all files'** to create an export of all the files you have.

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/47bec2d9-3c37-4a7a-994b-3d4ffb1665b3.jpg" alt="Export All Files" />
</Frame>
...
<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/74af6b5a-25eb-42f5-8169-98307ab83d2e.jpg" alt="Select Specific Files" />
</Frame>

Click on the dropdown button of export all files button.

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/a15cd0af-7326-41c6-a048-1140ac0152b3.jpg" alt="Export All Files Dropdown" />
</Frame>

Here select **Selected Files** from the dropdown.

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/e6cbac2f-1a14-4907-b1a0-126b8a8dbfbe.jpg" alt="Select Files from Dropdown" />
</Frame>

A popup window appears in which you have to fill in the essential details and then click on the **'Create'** button.

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/e01f9f2c-b93a-45b9-b43b-c71ca0d072c9.jpg" alt="Export Details Popup" />
</Frame>
...
1.  **CSV** - Select 'CSV' from the export format list. It's a plain text format used to store tabular data, where each line represents a data record, and each field within a record is separated by a comma.
    ...
    <CardGroup cols={2}>
      <Card>
        <Frame>
          <img src="https://d24lr4zqs1tgqh.cloudfront.net/621ef197-3568-4ccd-a376-25c30edd7bbe.jpg" alt="CSV Export Example 1" />
        </Frame>
      </Card>
      <Card>
        <Frame>
          <img src="https://d24lr4zqs1tgqh.cloudfront.net/82e79e21-6dc5-41d0-885b-3f534c57a313.jpg" alt="CSV Export Example 2" />
        </Frame>
      </Card>
    </CardGroup>
...
<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/9e127e43-56ba-4e52-83be-5ce18c290d34.jpg" alt="Exports Screen" />
</Frame>
...
<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/d8bbe83d-e280-4312-a263-f243280c72b5.jpg" alt="Download Export" />
</Frame>
