...
<Steps>
  <Step title="Access IAM Users">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/01bf539e-2a8c-47bf-931a-c5be4056ae3d.jpg" alt="IAM Users page" />
    </Frame>
  </Step>
  ...
  <Step title="Create User">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/6ff432ba-a19a-49b6-bc91-ce14a89988f0.jpg" alt="Create user form" />
    </Frame>
  </Step>
  ...
  <Step title="Set Permissions">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/6511d64e-bc48-4fa1-be11-1b9193e8ac3c.jpg" alt="Set permissions options" />
    </Frame>

    After choosing the above option you can see the list of existing policies

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/9a5111d7-02d2-4a39-8b84-f74a8b7e0c90.jpg" alt="Existing policies list" />
    </Frame>
  </Step>
  ...
  <Step title="Create Custom Policy">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/4aaaaf29-40e7-496b-a3a2-a7e197acaeae.jpg" alt="Create policy page" />
    </Frame>
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/88636772-4917-4ef4-8f33-2aeac6b377ce.jpg" alt="JSON policy editor" />
    </Frame>
  </Step>
  ...
  <Step title="Configure Policy Permissions">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/35c2200a-7a1f-416d-b948-9d809d3374cb.jpg" alt="JSON policy configuration" />
    </Frame>
  ...
  <Step title="Finalize Policy">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/e31c3f3b-aafa-4912-aa02-07ea526f5b7b.jpg" alt="Policy review page" />
    </Frame>

    Fill the **Policy name** & **Policy Description** and click on **Create policy** button

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/99e264a0-6854-49b5-ac8d-2c1e06c051c9.jpg" alt="Policy details form" />
    </Frame>

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/ad9368ab-f396-4666-a1bb-32292f88b7d2.jpg" alt="Create policy button" />
    </Frame>

    After this the policy will be created and listed

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/089f2488-21f1-4cf1-9921-5c855e972473.jpg" alt="Policy created successfully" />
    </Frame>
  </Step>
  ...
  <Step title="Attach Policy to User">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/eee79fb8-125e-471b-8861-b1ecc129952e.jpg" alt="Select policy for user" />
    </Frame>

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/3cb025ba-2dc1-4b3b-ad79-b3f8aad0a45d.jpg" alt="Policy attached to user" />
    </Frame>

    Now click on Create user button and user will be created

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/ac124329-39ad-4a6e-b3a7-5b7ceb156fe3.jpg" alt="Create user final step" />
    </Frame>

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/e3cce603-c13f-44cb-8c9c-af26f6db1737.jpg" alt="User created successfully" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Create Access Key">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/3b84e088-acdf-4181-8071-12cbfea6933e.jpg" alt="User details page" />
    </Frame>

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/c4634678-2c9a-430c-813e-fc48ed0d711a.jpg" alt="Create access key button" />
    </Frame>
  </Step>
  ...
  <Step title="Configure Access Key">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/4eff9cd1-3cef-49f8-be32-e095847e3725.jpg" alt="Access key use case" />
    </Frame>

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/56061786-5a93-4c2d-89c7-fd3ece2f766f.jpg" alt="Access key description" />
    </Frame>

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/42fc68e0-37eb-4e1d-afa3-3e415f2552a5.jpg" alt="Access key generated" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Select Amazon S3">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/fa5cc41d-689d-4129-8b12-0bc29c0dec5d.jpg" alt="Select Amazon S3 connector" />
    </Frame>
  </Step>
  ...
  <Step title="Configure Connection">
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/65890f6a-7f82-41b5-a999-1a19bc23e336.jpg" alt="S3 connection configuration" />
    </Frame>

    If you fill in the details correctly you will receive this message.

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/2c6947cd-f74f-450e-80fb-1911d8af1f38.jpg" alt="Connection successful" />
    </Frame>

    If you messed up somewhere you will get an error.

    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/87195405-1c70-4caf-84e6-68b020f9c88f.jpg" alt="Connection error" />
    </Frame>
    ...
    <Frame>
      <img src="https://d24lr4zqs1tgqh.cloudfront.net/720de949-0870-42e5-a13f-60d795c00670.jpg" alt="Connection name and description" />
    </Frame>
  </Step>
</Steps>
