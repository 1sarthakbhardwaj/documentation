...
<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/7cbdd36a-46fc-4bc4-ab15-792b278d410e.jpg" alt="Similar Images Example" />
</Frame>
...
<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/bb69b43f-7291-46e1-ae50-c7d1c56a30f7.jpg" alt="Image Similarity Data Prep" />
</Frame>
...
<Steps>
  <Step title="Data-Collection:">
    ...
    <Frame>
      <img src="https://storage.googleapis.com/labellerr-cdn/1%20%20Documentation/data-collection.webp" alt="Data Collection" />
    </Frame>
    ...
    <Frame>
      <img src="https://storage.googleapis.com/labellerr-cdn/1%20%20Documentation/data-imbalance.webp" alt="Data Imbalance" />
    </Frame>
  </Step>
  ...
  <Step title="Data-Curation :">
    ...
    **DUPLICATION :-** When the **same datasets are available at different sources**, challenges such as **duplication occurs**. Transformation of data may alter one source leaving the other source and result in incorrect data usage. **IMAGE SIMILARITY** can be used to find out the similar datasets or files .
    <Frame>
      <img src="https://storage.googleapis.com/labellerr-cdn/1%20%20Documentation/data-curation.webp" alt="Data Curation" />
    </Frame>
  </Step>
  ...
  <Step title="Data-Annotation:-">
    ...
    <Frame>
      <img src="https://storage.googleapis.com/labellerr-cdn/1%20%20Documentation/data-annotation.webp" alt="Data Annotation" />
    </Frame>
  </Step>
</Steps>
...
<Card title="Image Currently Under Annotation Process">
  <Frame>
    <img src="https://d24lr4zqs1tgqh.cloudfront.net/c6d8641d-68bf-4e7b-8c14-5b78e350428b.jpg" alt="Image under annotation" />
  </Frame>
</Card>
...
<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/04cb4064-141e-41e2-9ef6-1e2f5b4307dd.jpg" alt="Similar Images Rendered" />
</Frame>

Now one can view any specific image via **hovering on image** & clicking on **view** button as follow.

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/cb9adab3-a61e-4fce-a36f-9ebd21ffcfbc.jpg" alt="View Image Button" />
</Frame>

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/d3eb7e94-8e72-4e3e-8b66-c034ab9f0013.jpg" alt="Image View" />
</Frame>

To copy the answers from the compatible similar image. Click on **Copy Button** and then click the **Submit** button.

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/17d6c79a-7fe4-4b1a-bc50-5351dc372e67.jpg" alt="Copy Button" />
</Frame>

<Frame>
  <img src="https://d24lr4zqs1tgqh.cloudfront.net/c173f3f7-0253-4b11-8d88-d0d359245647.jpg" alt="Submit Button" />
</Frame>
